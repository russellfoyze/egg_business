  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center gap-1 sm:gap-1.5 bg-gradient-to-r from-cyan-400 to-sky-400 hover:from-cyan-300 hover:to-sky-300 text-slate-950 text-[10px] sm:text-xs font-black px-2 sm:px-3.5 py-1 sm:py-1.5 rounded-full border border-cyan-300/50 shadow-[0_0_14px_rgba(0,200,255,0.4)] transition-all hover:scale-105 active:scale-95 cursor-pointer shrink-0"
        title="খাতার ছবি থেকে সরাসরি JSON তৈরি বা গুগল শিটে সেভ করুন"
      >
        <Camera className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 text-slate-950" />
        <span className="hidden sm:inline">ছবি থেকে JSON</span>
        <span className="sm:hidden">OCR</span>
        <span className="hidden sm:inline bg-slate-950/25 text-slate-950 text-[9px] px-1.5 py-0.2 rounded-full font-black uppercase">AI</span>
      </button>
            ...
            <div className="px-5 py-3 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row justify-between items-center gap-2.5">
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <button
                  type="button"
                  onClick={() => setIsOpen(false)}
                  className="w-full sm:w-auto px-4 py-2 border border-slate-700/80 bg-slate-900/90 text-slate-300 hover:text-cyan-300 hover:border-cyan-500/60 rounded-full text-xs font-bold transition-all cursor-pointer shadow-sm active:scale-95"
                >
                  বন্ধ করুন
                </button>
              </div>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <button
                  type="button"
                  onClick={handleCopyJson}
                  className="w-full sm:w-auto px-4 py-2 bg-slate-900/90 hover:bg-cyan-950/40 text-cyan-400 hover:text-cyan-300 border border-cyan-500/60 hover:border-cyan-400 rounded-full text-xs font-bold flex items-center justify-center gap-1.5 transition-all shadow-[0_0_10px_rgba(0,200,255,0.2)] cursor-pointer active:scale-95"
                >
                ...
                <button
                  ...
                  disabled={isSaving}
                  className="w-full sm:w-auto px-5 py-2 bg-gradient-to-r from-cyan-400 to-sky-400 hover:from-cyan-300 hover:to-sky-300 text-slate-950 rounded-full text-xs font-black flex items-center justify-center gap-1.5 shadow-[0_0_16px_rgba(0,200,255,0.4)] border border-cyan-300/50 transition-all disabled:opacity-50 cursor-pointer active:scale-95"
                >
                  {isSaving ? (
                    <>
